...
\hlstd{}\hlstd{\ \ }\hlstd{}\hlslc{//il s'agit d'un compteur statique initialisé par le nombre de thread et qui est d é cr é ment é}\hspace*{\fill}\\
\hlstd{}\hlstd{\ \ \ \ }\hlstd{}\hlslc{//à la fin du traitement}\hspace*{\fill}\\
